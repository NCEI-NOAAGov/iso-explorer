...
| 2   | [dateType](/iso-explorer/ISO_19115_and_19115-2_CodeList_Dictionaries)                                         | 1     | Publication date identifies when the resource was issued and made publicly available. Creation date identifies when the resource was created or first date of data collection. Revision date identifies when the resource was changed.                                              |
